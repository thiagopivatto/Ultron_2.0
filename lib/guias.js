...
module.exports = {
    ...
    utilidade : {
        ...
        cotacao: cabecalho+
        "Ex: *!cotacao* - Exibe a cotação atual de algum ativo nas bolsas de valores ou criptos.",
        // simi: cabecalho+
        // "Ex: *!simi* - Alterna entre o modo ativo e inativo do Sim Simi.\n\n",
        // gerar: cabecalho+
        // "Ex: *!gerar* - Gera imagens através de uma IA.\n\n",
        // dalle: cabecalho+
        ...
        // vozparatexto: cabecalho+
        // "Ex: Responda um audio com *!vozparatexto* - Transforma o audio em texto.\n\n",
        // spleeter: cabecalho+
        // "*Obs*: Este comando funciona apenas com *AUDIOS*."+
        // "Ex: Responda um audio com *!spleeter* vocal - Separa o audio em 2 canais (vocal e instrumental) e envia apenas o vocal.\n\n"+
        // "Ex: Responda um audio com *!spleeter* instrumental - Separa o audio em 2 canais (vocal e instrumental) e envia apenas o instrumental.\n\n"
    },
    grupo:{
        regras: cabecalho+
        ...
        unban: cabecalho+
        "Ex: *!unban* - Para desbanir um membro respondendo ele.\n\n"+
        "Ex: Responder alguém com *!unban* - Desbane a pessoa que você respondeu.",
        rlink: cabecalho+
        ...
        mta: cabecalho+
        "Ex: *!mta* - Marca todos os *MEMBROS* do grupo de forma anônima.\n\n"+
        "Ex: *!mta* mensagem - Marca todos os *MEMBROS* do grupo com uma mensagem de forma anônima.",
        mm: cabecalho+
    ...
    diversao:{
        ...
        vod: cabecalho+ 
        "Ex: *!vod* [vdd/dsf] [nivel(1-5)] - Exibe uma pergunta aleatória para responder com *vdd* ou *dsf*.",
        buscatime: cabecalho+
        "Ex: *!buscatime* - Exibe informações do time digitado.",
        // infotime: cabecalho+
        // "Ex: *!infotime* - Exibe informações do time digitado.",
        jogadores: cabecalho+
        "Ex: *!jogadores* - Exibe os jogadores do time digitado.",
        // partidas: cabecalho+
        // "Ex: *!partidas* - Exibe as partidas do time digitado.",
        // jogosdodia: cabecalho+
        // "Ex: *!jogosdodia* - Exibe os jogos do dia escolhido.",
    },
    admin:{
        admin: cabecalho+
