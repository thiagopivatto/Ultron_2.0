...
|- *!ig* [link-post] - Faz download de um video/foto do Instagram e envia. (NÃO FUNCIONA)
|- *!fb* [link-post] - Faz download de um video do Facebook e envia. (NÃO FUNCIONA)
|- *!tw* [link-tweet] - Faz download de um video/foto do Twitter e envia. (NÃO FUNCIONA)
|- *!tk* [link-tiktok] - Faz download de um video do Tiktok e envia. (NÃO FUNCIONA)
|- *!img* [qtde imagens] [tema-imagem] - Faz download de uma imagem e envia. (NÃO FUNCIONA)
|
╰╼❥ ${process.env.NOME_BOT.trim()}® by *${process.env.NOME_ADMINISTRADOR.trim()}*`
    },
...
|- *!chat* - Faz uma pergunta para o Chat GPT-3.
|- *!cotacao* - Mostra a cotação de algum ativo nas bolsas de valores (NASDAQ, NYSE, B3) e Criptos.
|
╰╼❥ ${process.env.NOME_BOT.trim()}® by *${process.env.NOME_ADMINISTRADOR.trim()}*`
    },
...
|- *!mta* [mensagem] - Marca todos MEMBROS com uma mensagem anônima.
...
|- *!ban* @marcarmembro - Bane do grupo. (COMANDO SUSPENSO)
|- *!unban* @respondermembro - Desbane do grupo.
...
|- *!vod* - [vdd/dsf] [nivel(1-5)] - Exibe uma pergunta aleatória para responder com *vdd* ou *dsf*."
|- *!buscatime* [nome-time] - Exibe informações sobre o time escolhido.
|- *!jogadores* [nome-time] - Exibe os jogadores do time escolhido.
|
╰╼❥ ${process.env.NOME_BOT.trim()}® by *${process.env.NOME_ADMINISTRADOR.trim()}*`

// |- *|!infotime* [nome-time] - Exibe informações sobre o time escolhido.
// |- *!partidas* [nome-time] - Exibe as partidas do time escolhido.
// |- *!jogosdodia* [data] - Exibe os jogos do dia escolhido.
...
|- *!alternarcron* - Habilita/desabilita o cron de limpeza de chats.
