...
module.exports = {
    ...
    verificarEnv:()=>{
        ...
        let resposta = {
            ...
            googlecloud : {
              resposta: (process.env.GOOGLE_CLIENT_EMAIL.trim() == "??????" || process.env.GOOGLE_PRIVATE_KEY.trim() == "??????") ? "A API do GOOGLE CLOUD TTS ainda não foi configurada" : "✓ API GOOGLE CLOUD TTS Configurada.",
