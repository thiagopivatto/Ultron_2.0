...
### Run on CPU
```
python main.py --input path/to/an/audio/file
```

### Run on GPU
```
python main.py --input path/to/an/audio/file --gpu 0
```

### Advanced options
`--tta` option performs Test-Time-Augmentation to improve the separation quality.
```
python main.py --input path/to/an/audio/file --tta --gpu 0
```
...
```
python main.py --input path/to/an/audio/file --postprocess --gpu 0
```
